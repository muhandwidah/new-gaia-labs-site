...
$(document).ready(function () {
  function makeTimer() {
      ...
      $(".timer_7 .days").html(days + "<span>Days</span>");
      $(".timer_7 .hours").html(hours + "<span>Hours</span>");
      $(".timer_7 .minutes").html(minutes + "<span>Minutes</span>");
      $(".timer_7 .seconds").html(seconds + "<span>Seconds</span>");
  }
  setInterval(function () {
      makeTimer();
  }, 1000);
